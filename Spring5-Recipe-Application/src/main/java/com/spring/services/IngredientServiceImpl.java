...
import com.spring.converters.IngredientCommandToIngredient;
import com.spring.converters.IngredientToIngredientCommand;
...
public class IngredientServiceImpl implements IngredientService {
    ...
    public IngredientCommand findByRecipeIdAndIngredientId(Long recipeId, Long ingredientId) {
        ...
        // search for the ingredient id
        // filter the stream based on the ingredient id
        // when the object is found, map it into the ingredient command object
